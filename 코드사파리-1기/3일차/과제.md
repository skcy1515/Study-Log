# PyMongo로 MongoDB 조작하기 (chapter3_homework)
![image](https://github.com/user-attachments/assets/8065fa69-59d2-45a5-b686-f045e1f381aa)
...
if __name__ == '__main__':
    ...
    question3()
```
- `$gt` : 이 연산자는 "보다 크다"는 의미로, 비교 대상이 지정된 값보다 큰 값들을 찾거나 필터링할 때 사용된다.
- `$ne` : 이 연산자는 "같지 않다"는 의미로, 특정 값과 같지 않은 데이터를 필터링할 때 사용된다.
